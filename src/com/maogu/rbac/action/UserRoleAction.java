...
public class UserRoleAction extends BaseStruts2Action implements Preparable,ModelDriven{
	...
	//forward paths
	protected static final String QUERY_JSP = "/backend/UserRole/query.jsp";
	protected static final String LIST_JSP= "/backend/UserRole/list.jsp";
	protected static final String CREATE_JSP = "/backend/UserRole/create.jsp";
	protected static final String EDIT_JSP = "/backend/UserRole/edit.jsp";
	protected static final String SHOW_JSP = "/backend/UserRole/show.jsp";
	//redirect paths,startWith: !
	protected static final String LIST_ACTION = "!/backend/UserRole/list.do";
	...
	public void setDi(java.lang.Integer val) {
		this.id = val;
	}
	...
	public String delete() {
		for(int i = 0; i < items.length; i++) {
			...
			java.lang.Integer id = new java.lang.Integer((String)params.get("di"));
